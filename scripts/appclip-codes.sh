...
# Only generate codes after https://holoweb.app/c/ is registered as an advanced App Clip experience
...
for code in $(node -e 'console.log(Object.keys(require("./content/shortlinks.json")).join(" "))'); do
  ...
  AppClipCodeGenerator generate --url "https://holoweb.app/c/$code" \
